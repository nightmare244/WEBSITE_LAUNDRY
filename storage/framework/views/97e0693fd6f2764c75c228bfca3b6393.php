        ...
        <div class="mx-auto max-w-7xl space-y-7 p-5 sm:p-8">
            ...
            <section class="grid gap-6 lg:grid-cols-3">
                ...
                <div class="h-fit rounded-2xl border border-slate-200 bg-white p-5 shadow-sm lg:col-span-1">
                    ...
                    <form
                        method="POST"
                        action="<?php echo e(route('admin.orders.store')); ?>"
                        class="space-y-4"
                    >
                        ...
                        <div>
                            ...
                            <p class="mt-1 text-xs text-slate-400">
                                Tarif:
                                Rp <?php echo e(number_format(config('laundry.rate'), 0, ',', '.')); ?>/kg
                            </p>
                        ...
                        <div>
                            ...
                            <input
                                ...
                                value="<?php echo e(old('estimated_ready_at')); ?>"
                                class="w-full rounded-xl border border-slate-200 bg-slate-50 px-4 py-3 text-sm outline-none transition focus:border-cyan-500 focus:bg-white focus:ring-2 focus:ring-cyan-100"
                            >
                ...
                <div class="overflow-hidden rounded-2xl border border-slate-200 bg-white shadow-sm lg:col-span-2">
                    ...
                    >
                        ...
                        >
                            ...
                            <?php $__currentLoopData = config('laundry.statuses'); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $label): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>

                                <option
                                    value="<?php echo e($key); ?>"
                                    <?php if($status === $key): echo 'selected'; endif; ?>
                                >
                                    <?php echo e($label); ?>
                                ...
                                <?php $__empty_1 = true; $__currentLoopData = $orders; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $order): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                    ...
                                    <tr class="transition hover:bg-cyan-50/30">
                                        ...
                                        <td class="px-5 py-5">
                                            ...
                                            <div class="mt-1 text-xs text-slate-400">
                                                +<?php echo e($order->whatsapp_number); ?>
                                        ...
                                        <td class="px-5 py-5">
                                            ...
                                            <div class="font-bold text-slate-700">
                                                <?php echo e(number_format((float) $order->weight, 2, ',', '.')); ?>
                                        ...
                                        <td class="px-5 py-5">
                                            ...
                                            >
                                                ...
                                                <select
                                                    ...
                                                    class="rounded-lg border-0 px-3 py-2 text-xs font-bold <?php echo e($statusColor); ?> focus:ring-2 focus:ring-cyan-400"
                                                >
                                                    ...
                                                    <?php $__currentLoopData = config('laundry.statuses'); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $label): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                        ...
                                                        <option
                                                            value="<?php echo e($key); ?>"
                                                            <?php if($order->status === $key): echo 'selected'; endif; ?>
                                                        >
                                                            <?php echo e($label); ?>
                                        ...
                                        <td class="px-5 py-5">
                                            ...
                                            <?php if($order->estimated_ready_at): ?>
                                                ...
                                                <div class="font-semibold text-slate-700">
                                                    ...
                                                    <?php echo e($order->estimated_ready_at->format('d M Y')); ?>
                                                ...
                                                <div class="mt-1 text-xs text-slate-400">
                                                    ...
                                                    <?php echo e($order->estimated_ready_at->format('H:i')); ?>
                                        ...
                                        <td class="px-5 py-5">
                                            ...
                                            <div class="flex justify-end gap-2">
                                                ...
                                                <a
                                                    href="<?php echo e(route('admin.orders.edit', $order)); ?>"
                                                ...
                                                <button
                                                    ...
                                                    onclick='notifyCustomer(
                                                        <?php echo json_encode($order->whatsapp_number, 15, 512) ?>,
                                                        <?php echo json_encode($order->customer_name, 15, 512) ?>,
                                                        <?php echo json_encode($order->order_code, 15, 512) ?>,
                                                        <?php echo json_encode($order->status_label, 15, 512) ?>,
                                                        <?php echo json_encode(optional($order->estimated_ready_at)->format("d M Y, H:i") ?? "akan diinformasikan", 512) ?>
                                                    )'
                                                ...
                                                <a
                                                    href="<?php echo e(route('admin.orders.receipt', $order)); ?>"
                                                    target="_blank"
                                                ...
                                                <form
                                                    ...
                                                    onsubmit="return confirm('Arsipkan pesanan <?php echo e($order->order_code); ?>?')"
                                                >
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\My_Project\WEBSITE LAUNDRY\resources\views/admin/dashboard.blade.php ENDPATH**/ ?>